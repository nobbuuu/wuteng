...
;(function ($, window, document, undefined) {
    ...
    Shutter.prototype = {
        ...
        toggleMove: function (command, index) {
            ...
            this.moveSwitch(this.opts.playType, command, index);
        ...
        inital: function (elem) {
            ...
            //初始化插件
            console.log("最新插件属性：" + JSON.stringify(this.opts));
        ...
        gridWhole: function (index, showNum) {
            ...
            if (showNum === 0) {
                ...
                $createElem.velocity({left: movingVal}, {duration: this.opts.duration});
            } else if (showNum === 1) {
                movingVal = -this.shutterW;
                ...
                $createElem.velocity({top: movingVal}, {duration: this.opts.duration});
            } else if (showNum === 3) {
                movingVal = -this.shutterH;
                $createElem.velocity({top: movingVal}, {duration: this.opts.duration});
            }
            ...
            this.recovery($targetElem, $curElem, index, backup, this.opts.duration + 200);
        },
        ...
        gridTop: function (index, showNum) {
            ...
            if (showNum === 0) {
                ...
                $curElem.find('.created').each(function (i) {
                    ...
                    $(this).velocity({top: movingVal}, {duration: self.opts.duration});
                });
            } else if (showNum === 1) {
                $curElem.find('.created').each(function (i) {
                    speed = 80 * i;
            ...
            this.recovery($targetElem, $curElem, index, backup, self.opts.duration + 200);
        },
        ...
        gridLeft: function (index, showNum) {
            ...
            if (showNum === 0) {
                ...
                $curElem.find('.created').each(function (i) {
                    ...
                    $(this).velocity({left: movingVal}, {duration: self.opts.duration});
                });
            } else if (showNum === 1) {
                $curElem.find('.created').each(function (i) {
                    speed = 80 * i;
