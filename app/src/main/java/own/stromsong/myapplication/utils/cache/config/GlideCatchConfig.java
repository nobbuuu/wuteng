package own.stromsong.myapplication.utils.cache.config;
...
public class GlideCatchConfig {
    ...
    public static final int GLIDE_CATCH_SIZE = 200 * 1000 * 1000;

    // 图片缓存子目录
    public static final String GLIDE_CARCH_DIR = "app_image_catch";
