...
public class DateFormatUtil {
   ...
   public static Date getTime(String dateStr, String formatStr){
    ...
    public static String getTime(String dateStr, String formatStr,String formatedStr){
        if (StringUtil.NoNullOrEmpty(dateStr)){
            Date time = getTime(dateStr, formatStr);
            return getTime(time,formatedStr);
        }else {
            return "";
        }
    }
